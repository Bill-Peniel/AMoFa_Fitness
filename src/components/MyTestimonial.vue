  ...
  <div class="container">
    ...
    <div class="slider-text">
      <div id="owl-testi" class="owl-carousel owl-theme">
        <div class="item">
          <div  class="col-md-10 col-md-offset-1"> <img src="/assets/images/Testimonials/02.jpg" class="img-circle" alt="">
        ...
        <div  class="col-md-10 col-md-offset-1"> <img src="/assets/images/Testimonials/03.jpg" class="img-circle" alt="">
        ...
        <div  class="col-md-10 col-md-offset-1"> <img src="/assets/images/Testimonials/04.jpg" class="img-circle" alt="">
